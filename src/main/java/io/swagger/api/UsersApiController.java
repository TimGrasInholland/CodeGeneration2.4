...
public class UsersApiController implements UsersApi {
    ...
    public ResponseEntity<Void> deleteUser(@Min(1)@ApiParam(value = "",required=true, allowableValues="") @PathVariable("id") Integer id
) {
